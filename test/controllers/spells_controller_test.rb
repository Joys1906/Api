...
class SpellsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spell" do
    assert_difference("Spell.count") do
      post spells_url, params: { spell: { effect: @spell.effect, name: @spell.name, type: @spell.type } }, as: :json
    end
  ...
  test "should update spell" do
    patch spell_url(@spell), params: { spell: { effect: @spell.effect, name: @spell.name, type: @spell.type } }, as: :json
    assert_response :success
  end
